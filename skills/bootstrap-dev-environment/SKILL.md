...
7. **Generate or update `CLAUDE.md`** at the repo root. Merge with any existing content rather than overwriting. Include pointers to `clif-d/backpressure.md` and the "no inline suppressions" rule.
